...
public abstract class NeuralLayer implements Serializable {
   ...
   */
  protected Doubles input;
  /**
   * Array of output values this Layer will produce
   */
  protected Doubles output;
  /**
  ...
  public NeuralLayer(int numberofneurons) {
    ...
    output = new Doubles(numberofneurons);
  }
    ...
    if (numberOfNeuronsInLayer >= 0) {
      for (int i = 0; i < numberOfNeuronsInLayer; i++) {
        try {
          ...
          neuron.get(i).init(doubleIterator);
   ...
   * @see NeuralInput
   */
  protected void setInputs(Doubles inputs) {
